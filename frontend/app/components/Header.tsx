  ...
  const menus = props.isAuthenticated ? (
    <>
      <li className="nav-item">
        <Link className={clsx("nav-link", createActiveClassName("home", props.activeMenu))} to="/">
          Home
        </Link>
      </li>
      <li className="nav-item">
        <Link className={clsx("nav-link", createActiveClassName("newArticle", props.activeMenu))} to="/editor">
          <i className="ion-compose"></i>&nbsp;New Article
        </Link>
      </li>
      <li className="nav-item">
        <Link className={clsx("nav-link", createActiveClassName("settings", props.activeMenu))} to="/settings">
